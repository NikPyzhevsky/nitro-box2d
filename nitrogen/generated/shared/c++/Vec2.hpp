...
namespace margelo::nitro::nitrobox2d {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Vec2).
   */
  struct Vec2 final {
  public:
  ...
  public:
    friend bool operator==(const Vec2& lhs, const Vec2& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ Vec2 <> JS Vec2 (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrobox2d::Vec2> final {
    static inline margelo::nitro::nitrobox2d::Vec2 fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrobox2d::Vec2(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrobox2d::Vec2& arg) {
